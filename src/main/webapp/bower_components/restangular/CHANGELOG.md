...
* `codigo` configuration from `restangularFields` now accepts nested (dotted) properties
...
# 0.3.3
* Restangular fields can now be configured. You can set the codigo, route and parentResource fields. They're not hardcoded anymore
